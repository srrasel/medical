          ...
          <div className="grid grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/department" className="text-gray-300 hover:text-white transition-colors">Our Departments</Link></li>
                <li><Link href="/doctors" className="text-gray-300 hover:text-white transition-colors">Our Doctors</Link></li>
                <li><Link href="/packages" className="text-gray-300 hover:text-white transition-colors">Our Packages</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mb-6">
                <Link href="https://www.google.com/maps" className="text-gray-300 hover:text-white transition-colors flex items-start gap-2">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Link href="mailto:info@unicohospitals.com" className="text-gray-300 hover:text-white transition-colors flex items-center gap-2">
                    <Mail className="w-4 h-4" />
                    info@unicohospitals.com
                  </Link>
                  <Link href="mailto:career@unicohospitals.com" className="text-gray-300 hover:text-white transition-colors flex items-center gap-2">
                    <Mail className="w-4 h-4" />
                    career@unicohospitals.com
                  </Link>
                  <Link href="tel:09677667766" className="text-gray-300 hover:text-white transition-colors flex items-center gap-2">
            ...
            <div>
              <div className="space-y-4 mb-8">
                <Link href="/doctors" className="group flex items-center justify-between bg-blue-600 hover:bg-blue-700 transition-all duration-300 px-4 py-3 rounded-lg">
                ...
                <Link href="/department" className="group flex items-center justify-between bg-green-600 hover:bg-green-700 transition-all duration-300 px-4 py-3 rounded-lg">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/packages" className="group flex items-center justify-between bg-purple-600 hover:bg-purple-700 transition-all duration-300 px-4 py-3 rounded-lg">
                  <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <Link href="https://www.facebook.com/unicohospitals" className="p-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors">
                    <Facebook className="w-5 h-5" />
                  </Link>
                  <Link href="https://www.instagram.com/unicohospitalsplc" className="p-2 bg-pink-600 hover:bg-pink-700 rounded-lg transition-colors">
                    <Instagram className="w-5 h-5" />
                  </Link>
                  <Link href="https://www.linkedin.com/company/90650076" className="p-2 bg-blue-700 hover:bg-blue-800 rounded-lg transition-colors">
                    <Linkedin className="w-5 h-5" />
                  </Link>
                  <Link href="https://www.youtube.com/@UnicoHospitals" className="p-2 bg-red-600 hover:bg-red-700 rounded-lg transition-colors">
